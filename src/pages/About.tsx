...
import { Heart, Target, Users, Lightbulb, Star, Camera, Video } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full opacity-20"
              />
              <motion.div
                animate={{ rotate: -360 }}
                transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                className="absolute -bottom-4 -left-4 w-10 h-10 bg-gradient-to-r from-purple-400 to-blue-500 rounded-full opacity-20"
              />
            </motion.div>
          </div>
        </div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className="flex-1">
                  <div className={`${index % 2 === 0 ? 'text-right pr-6' : 'text-left pl-6'}`}>
                    <div className="text-xl font-bold text-amber-400 mb-2">{item.year}</div>
                ...
                <div className="w-12 h-12 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full flex items-center justify-center flex-shrink-0 z-10">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-amber-400 transition-all duration-300 group"
            >
              <Camera className="w-10 h-10 text-amber-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
              <h3 className="text-xl font-bold text-white mb-3">Photography Services</h3>
            ...
            <motion.div
              ...
              className="bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-amber-400 transition-all duration-300 group"
            >
              <Video className="w-10 h-10 text-amber-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
              <h3 className="text-xl font-bold text-white mb-3">Videography Services</h3>
              <ul className="space-y-2 text-gray-400 text-sm">
          ...
          >
            ...
            <Link to="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-white text-slate-900 px-6 py-3 rounded-full font-bold hover:shadow-xl transition-all duration-300"
              >
                Get In Touch
              </motion.button>
            </Link>
